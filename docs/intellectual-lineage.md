...
- Born - same year as Pferd's telephone dial governor paper
...
### 1970s-1980s: Symbolics Era

- Joined Symbolics Corporation (MIT AI Lab lineage)
- Worked with Tom McMahon (TLM), Dan Weinreb (DLW), and others
- Lisp Machines, live development environments
- **Symbolics.com** - first .com domain (March 15, 1985)
- *[See parallel graphics/computation history in [graphs-in-computation.md](graphs-in-computation.md)]*
