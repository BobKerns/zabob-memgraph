...
But important to the context of the story, Tom is also a life-long resident of of the Playa Del Rey/Playa Vista community, effectively the local historian, and through him I know more about Playa Del Rey, is history, and its local politics than I do my own community.
...
There used to be a nice video of the work of replacing the anchor a few years back, but it doesn't seem to be online.
...
But LA's history with oil comes into it. Take a look at this map.

![alt text](image-3.png)

- The red rectangle is the Chevron plant I mentioned.
- Green is the Scattergood Generating Station, central to this whole story.
- Pale blue is some black dots on LAX runways.
- Black dots? Abandoned oil wells. At this scale, they stack on top of each other. Yes, including under LAX runways. LA is a sieve!
...
It is much like its much larger sibling, the Aliso Canyon field with the huge blowout in 2016, but smaller and more local. Te Aliso Canyon blowout left Southern California short on gas, jump starting our investment in battery storage of electricity instead.

(I am trying to stay on topic while still tying it to the much larger contexts this all connects on).

This is the pumping and dewatering infrastructure for the PDR field.

![PDR storage field infrastructure](image-4.png)

I could go into a LOT more detail, about Scattergood's past and future. Its last upgrade cost nearly $1B, which isn't out of line for our energy infrastructure; the next will be considerably more.

Personally, I don't think Scattergood itself should have a future of any significance. Originally, its advantage was access to gas from the sewage plant next door, and cooling water from the ocean.

But Hyperion has its own 28 MW cogeneration facility (two turbines) since 2015.

But rather than do that let me close with sort of a postscript from Tom himself, from just last year.
